                    ...
                    >
                        <div className="bg-white px-4 pt-5 pb-1">
                            <div className="sm:flex sm:items-start">
                                <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-green-100 sm:mx-0 sm:size-24">
                                    <CurrencyDollarIcon aria-hidden="true" className="size-16 text-green-400" />
                                </div>
                        ...
                        <div className="bg-gray-50 py-3 flex flex-row justify-end px-6 space-x-5">
                            <button
                                type="button"
                                onClick={onClose}
                                className="text-lg font-medium bg-[#281d73] px-10 py-2 text-center text-gray-50 rounded-xs"
                            >
                                Deposit
                            </button>
                            <button
